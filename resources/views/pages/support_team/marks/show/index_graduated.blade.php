...
@section('content')
    ...
    <div class="card">
        <div class="card-header text-center">
            <h4 class="card-title font-weight-bold">Nilai Siswa =>  {{ $sr->user->name.' ('.$my_class->name.' '.$my_class->section->first()->name.')' }} </h4>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body collapse">
                        ...
                        <div class="text-center mt-3">
                            <a target="_blank" href="{{ route('marksgraduated', [Qs::hash($student_id), $ex->id, $year]) }}" class="btn btn-secondary btn-lg">Print <i class="icon-printer ml-2"></i></a>
                        </div>
                    </div>
                </div>
