...
@section('page_title', 'Atur Pembayaran')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title font-weight-bold">Atur Pembayaran Untuk Siswa {{ $sr->user->name}} </h6>
            {!! Qs::getPanelOptions() !!}
        </div>
            ...
            <div class="tab-pane fade show active" id="all-uc">
                <table class="table datatable-button-html5-columns table-responsive">
                    ...
                    <tr>
                        ...
                        <th>Paid</th>
                        <th>Balance</th>
                        <th colspan="6">Bayar Sekarang</th>
                        <th>No_Kuitansi</th>
                        <th>Tahun</th>
                        <th>Aksi</th>
                    </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                             ...
                             <div class="row">
                                 ...
                                 <div class="col-md-3">
                                     <button data-text="Pay" class="btn btn-danger" type="submit">Bayar</button>
                                 </div>
                             </div>
                                </form>
                            </td>
