    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                @if(Qs::userIsPTA())
                    <li class="nav-item"><a href="#edit-profile" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Atur Profil</a></li>
                @endif
            </ul>
                        ...
                        <div class="col-md-8">
                            <form method="post" action="{{ route('my_account.change_pass') }}">
                                ...
                                <div class="form-group row">
                                    <label for="current_password" class="col-lg-3 col-form-label font-weight-semibold">Password Saat ini<span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form enctype="multipart/form-data" method="post" action="{{ route('my_account.update') }}">
                                    ...
                                    <div class="form-group row">
                                        <label for="Nomor Hp" class="col-lg-3 col-form-label font-weight-semibold">Nomor Hp</label>
                                        <div class="col-lg-9">
                                    ...
                                    <div class="form-group row">
                                        <label for="address" class="col-lg-3 col-form-label font-weight-semibold">Ubah Foto Profil </label>
                                        <div class="col-lg-9">
