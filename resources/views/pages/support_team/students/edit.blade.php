...
@section('content')
        ...
        <div class="card">
            <div class="card-header bg-white header-elements-inline">
                <h6 id="ajax-title" class="card-title">Silahkan Isi Form Dibawah Untuk Edit Profil Siswa {{ $sr->user->name }}</h6>
            ...
            <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" data-reload="#ajax-title" action="{{ route('students.update', Qs::hash($sr->id)) }}" data-fouc>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="dob" value="{{ $sr->user->dob  }}" type="text" class="form-control date-pick" data-date-format="dd/mm/yyyy" placeholder="Pilih Tanggal...">
                            </div>
                        </div> 
                ...
                <fieldset>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="section_id">Tingkat: </label>
