...
@section('page_title', 'Pilih Rekap Nilai Siswa')
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-books mr-2"></i> Pilih Rekap Nilai Siswa</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mt-4">
                            <div class="text-right mt-1">
                                <button type="submit" class="btn btn-primary">Lihat Daftar Nilai </button>
                            </div>
                        </div>
            ...
            <table class="table datatable-button-html5-columns">
                ...
                @foreach($students as $s)
                    <tr>
                        ...
                        <td>{{ $s->user->name }}</td>
                        <td>{{ $s->adm_no }}</td>
                        <td><a class="btn btn-danger" href="{{ route('marks.year_select', Qs::hash($s->user_id)) }}">Lihat Daftar Nilai</a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
