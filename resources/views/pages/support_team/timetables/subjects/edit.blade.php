<div class="tab-pane fade" id="edit-subs">
    ...
    @if($tts->count())
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title font-weight-bold"> {{ ($tt->exam_date ? ($tt->exam_date) : $tt->day) }} {{ '('.$tt->time_slot->full.')' .' - '.$tt->subject->name }}</h6>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input autocomplete="off" name="exam_date"
                                                           ...
                                                           type="text" class="form-control date-pick" data-date-format="dd/mm/yyyy"
        ...
        <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <select data-placeholder="Pilih Slot Waktu..." required class="select form-control" name="ts_id" id="ts_id">
        ...
        @endforeach
    @else
        <div class="alert alert-info text-center">Belum ada data yang dapat ditampilkan/ <b>Refresh halaman ini </b>       </div>
    @endif
</div>
