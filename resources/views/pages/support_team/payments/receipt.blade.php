<html>
<head>
    <title>Kuitansi_{{ $pr->ref_no.'_'.$sr->user->name }}</title>
...
<div class="container">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/> <br/>
                     ...
                     <span style="color: #000; font-weight: bold; font-size: 25px;">KUITANSI PEMBAYARAN</span>
                </td>
            </tr>
        </table>
    ...
    <div class="bold arial" style="text-align: center; float:right; width: 200px; padding: 5px; margin-right:30px">
        <div style="padding: 10px 20px; width: 200px; background-color: lightcyan;">
            <span  style="font-size: 16px;">No Kuitansi.</span>
        </div>
       ...
       <div style="float: left; margin-left: 20px">
           <table style="font-size: 16px" class="td-left" cellspacing="5" cellpadding="5">
               ...
               <tr>
                   <td class="bold">NOMOR INDUK/NISN:</td>
                   <td>{{ $sr->adm_no }}</td>
               </tr>
               <tr>
        ...
        <table class="td-left" style="font-size: 16px" cellspacing="2" cellpadding="2">
                <tr>
                    ...
                    <td class="bold">JENIS PEMBAYRAN:</td>
                    <td>{{ $payment->title }}</td>
                </tr>
                <tr>
                    <td class="bold">JUMLAH:</td>
                    <td>{{ $payment->amount }}.000,00</td>
        ...
        <table class="td-left" style="font-size: 16px" width="100%" cellspacing="2" cellpadding="2">
           ...
           <tr>
               ...
               <td class="bold">Jumlah Terbayarkan</td>
               <td class="bold">Belum Terbayarkan</td>
           </tr>
           </thead>
            <tbody>
        ...
        <div class="bold arial" style="text-align: center; float:right; width: 200px; padding: 5px; margin-right:30px">
            <div style="padding: 10px 20px; width: 200px; background-color: lightcyan;">
                <span  style="font-size: 16px;">{{ $pr->paid ? 'STATUS PEMBAYARAN' : 'Jumlah yang Belum Terbayarkan' }}</span>
            </div>
            <div  style="padding: 10px 20px; width: 200px; background-color: lightyellow;">
