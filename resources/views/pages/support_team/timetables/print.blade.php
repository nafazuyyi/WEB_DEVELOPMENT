...
<div class="container">
    <div id="print" xmlns:margin-top="http://www.w3.org/1999/xhtml">
        ...
        <table width="100%">
            <tr>
                <td >
                    ...
                    <br /> <br />
                    <strong><span style="color: #000; font-size: 15px;">JADWAL {{ strtoupper($my_class->name. ' ('.$ttr->year.')' ) }}
                    </span></strong>
                </td>
            </tr>
        </table>
        ...
        {{-- Tabulation Begins --}}
        <table cellpadding="10" style="width:100%; border-collapse:collapse; border: 1px solid #000; margin: 10px auto;" border="1">
            <thead>
            <tr>
                <th rowspan="2" style=" color: rgb(255, 60, 60);">Jam  <i class="icon-arrow-right7 ml-2"></i> 
                <hr style=" border: 1px solid rgb(48, 103, 223);
                    border-radius: 5px;"> Hari<i class="icon-arrow-down7 ml-2"></i>
                </th>
