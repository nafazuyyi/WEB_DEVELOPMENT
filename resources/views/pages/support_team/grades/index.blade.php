...
@section('page_title', 'Atur Batas Nilai')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Atur Batas Nilai</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-grades" class="nav-link active" data-toggle="tab">Atur Batas Nilai</a></li>
                <li class="nav-item"><a href="#new-grade" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> Tambah Batas Nilai</a></li>
            </ul>
                        ...
                        <div class="col-md-6">
                            <form method="post" action="{{ route('grades.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="name" value="{{ old('name') }}" required type="text" class="form-control" placeholder="Cth. A-">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Dari Nilai <span class="text-danger">*</span></label>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">Sampai Nilai <span class="text-danger">*</span></label>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group row">
                                    <label for="remark" class="col-lg-3 col-form-label font-weight-semibold">Pilih Definisi</label>
                                    <div class="col-lg-9">
