...
@section('page_title', 'Atur Tagihan')
@section('content')
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group">
                                    ...
                                    <select data-placeholder=" Pilih Tahun" required id="year" name="year" class="form-control select">
                                        @foreach($years as $yr)
...
@if($selected)
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Atur Pembayaran pada Tahun Pelajaran {{ $year }} </h6>
            {!! Qs::getPanelOptions() !!}
        </div>
